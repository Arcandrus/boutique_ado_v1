    ...
    if size:
        if item_id in list(bag.keys()):
            if size in bag[item_id]['items_by_size'].keys():
                ...
                bag[item_id]['items_by_size'][size] = quantity
                messages.success(request, f'Added {quantity} size {size.upper()} {product.name} to bag')
        else:
            bag[item_id] = {'items_by_size': {size: quantity}}
            messages.success(request, f'Added {quantity} size {size.upper()} {product.name} to your bag')
    else:
        if item_id in list(bag.keys()):
